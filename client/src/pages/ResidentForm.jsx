...
export default function ResidentForm() {
  ...
  return (
    <div className="prof-page">
      ...
      <form className="card resident-edit" onSubmit={save}>
        <div className="resident-edit-body">
        ...
        <div className="flat-save">
          <p className="flat-save-msg">
            {u.status === 'pending'
              ? 'Set status to Approved, then save.'
              : 'Saves status, block and flat.'}
          </p>
          <button className="btn btn-primary" type="submit">
            {u.status === 'pending' && status === 'approved' ? 'Approve resident' : 'Save'}
          </button>
        </div>
      </form>
    </div>
